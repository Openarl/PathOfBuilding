...
{ 1, "SkillTypeStats", 1, "Skill type-specific Stats", colorCodes.OFFENCE, {
	...
	{ label = "Physical Reduction", flag = "totem", { format = "{0:output:TotemPhysicalDamageReduction}%",
		{ breakdown = "TotemPhysicalDamageReduction" },
		{ modName = "TotemPhysicalDamageReduction", cfg = "skill" },
	}, },
	{ label = "Fire Resist", flag = "totem", { format = "{0:output:TotemFireResist}% (+{0:output:TotemFireResistOverCap}%)",
		{ breakdown = "TotemFireResist" },
		{ modName = { "TotemFireResistMax", "TotemFireResist", "TotemElementalResist" }, cfg = "skill" },
	}, },
	{ label = "Cold Resist", flag = "totem", { format = "{0:output:TotemColdResist}% (+{0:output:TotemColdResistOverCap}%)",
		{ breakdown = "TotemColdResist" },
		{ modName = { "TotemColdResistMax", "TotemColdResist", "TotemElementalResist" }, cfg = "skill" },
	}, },
	{ label = "Lightning Resist", flag = "totem", { format = "{0:output:TotemLightningResist}% (+{0:output:TotemLightningResistOverCap}%)",
		{ breakdown = "TotemLightningResist" },
		{ modName = { "TotemLightningResistMax", "TotemLightningResist", "TotemElementalResist" }, cfg = "skill" },
	}, },
	{ label = "Chaos Resist", flag = "totem", { format = "{0:output:TotemChaosResist}% (+{0:output:TotemChaosResistOverCap}%)",
		{ breakdown = "TotemChaosResist" },
		{ modName = { "TotemChaosResistMax", "TotemChaosResist" }, cfg = "skill" },
	}, },
} },
