...
local jewelThresholdFuncs = {
	...
	["With at least 40 Intelligence in Radius, Raised s' Slam Attack deals 30% increased Damage"] = getThreshold("Int", "MinionModifier", "LIST", { mod = mod("Damage", "INC", 30, { type = "SkillId", skillId = "ZombieSlam" }) }),
