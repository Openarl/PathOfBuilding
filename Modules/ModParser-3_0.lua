...
local specialModList = {
	...
	-- Sabotuer
	-- Slayer
	["deal up to 15%% more melee damage to enemies, based on proximity"] = function(num) return { mod("Damage", "MORE", num, nil, ModFlag.Melee, { type = "Condition", var = "AtCloseRange" }) } end,
	-- Trickster
