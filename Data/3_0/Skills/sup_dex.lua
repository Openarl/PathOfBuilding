...
skills["SupportChain"] = {
	...
	levelMods = {
		[1] = nil, 
		--[2] = "support_chain_hit_damage_+%_final"
	},
	levels = {
		[1] = { 38, -50, },
		[2] = { 40, -49, },
...
skills["SupportClusterTrap"] = {
	...
	excludeSkillTypes = { },
	effects = {
		[1] = "Supported Skills deal (26-55)% less Damage",
...
skills["SupportDamageAgainstChilled"] = {
	...
	excludeSkillTypes = { },
	effects = {
		[1] = "20% increased Effect of Chill",
...
skills["SupportFrenzyChargeOnSlayingFrozenEnemy"] = {
	...
	excludeSkillTypes = { },
	effects = {
		[1] = "(50-79)% chance to gain a Frenzy Charge on Killing a Frozen Enemy",
	...
	levelMods = {
		...
		--[3] = "minimum_added_cold_damage_per_frenzy_charge"
		--[4] = "maximum_added_cold_damage_per_frenzy_charge"
...
skills["SupportMultiTrap"] = {
	...
	excludeSkillTypes = { },
	effects = {
		[1] = "Supported Skills deal (11-40)% less Damage",
...
skills["SupportPhysicalProjectileAttackDamage"] = {
	...
	excludeSkillTypes = { },
	effects = {
		[1] = "Supported Attack Skills deal (30-59)% more Damage with Bleeding and Poison caused by Projectile Hits",
	...
	levelMods = {
		...
		--[3] = "support_phys_proj_attack_damage_bleeing_and_poison_damage_+%_final_from_projectile_hits"
	},
	levels = {
		[1] = { 18, 30, 30, },
		[2] = { 22, 31, 31, },
...
skills["SupportTrapAndMineDamage"] = {
	...
	excludeSkillTypes = { },
	effects = {
		[1] = "Supported Skills deal (20-49)% more Trap and Mine Damage",
