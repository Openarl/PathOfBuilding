...
return {
	...
	["Metadata/Items/Gems/SkillGemVaalGroundSlam"] = {
		...
		tagString = "Vaal, Attack, AoE, Physical, Melee",
		reqStr = 100,
		reqDex = 0,
		reqInt = 0,
		defaultLevel = 20,
	...
	["Metadata/Items/Gems/SkillGemPunishment"] = {
		...
		tagString = "Spell, AoE, Duration, Curse, Physical",
		reqStr = 60,
		reqDex = 0,
		reqInt = 40,
		defaultLevel = 20,
	...
	["Metadata/Items/Gems/SkillGemVulnerability"] = {
		...
		tagString = "Spell, AoE, Duration, Curse, Chaos",
		reqStr = 0,
		reqDex = 0,
		reqInt = 100,
		defaultLevel = 20,
	...
	["Metadata/Items/Gems/SkillGemFlammability"] = {
		...
		tagString = "Spell, AoE, Duration, Curse, Fire",
		reqStr = 40,
		reqDex = 0,
		reqInt = 60,
		defaultLevel = 20,
	...
	["Metadata/Items/Gems/SkillGemFrostbite"] = {
		...
		tagString = "Spell, AoE, Duration, Curse, Cold",
		reqStr = 0,
		reqDex = 40,
		reqInt = 60,
		defaultLevel = 20,
	...
	["Metadata/Items/Gems/SkillGemConductivity"] = {
		...
		tagString = "Spell, AoE, Duration, Curse, Lightning",
		reqStr = 0,
		reqDex = 0,
		reqInt = 100,
		defaultLevel = 20,
	...
	["Metadata/Items/Gems/ConsecratedPath"] = {
		...
		tagString = "Fire, Attack, AoE, Movement, Duration, Melee",
		reqStr = 60,
		reqDex = 0,
		reqInt = 40,
		defaultLevel = 20,
	...
	["Metadata/Items/Gems/SkillGemWinterOrb"] = {
		...
		tagString = "Cold, Spell, Channelling, AoE, Duration, Projectile",
		reqStr = 0,
		reqDex = 0,
		reqInt = 100,
		defaultLevel = 20,
	...
	["Metadata/Items/Gems/SkillGemDarkRitual"] = {
		...
		tagString = "Chaos, Trigger, Spell, AoE, Duration, Curse",
		reqStr = 0,
		reqDex = 0,
		reqInt = 100,
		defaultLevel = 20,
